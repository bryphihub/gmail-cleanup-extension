...
This project was built collaboratively with Codex across many chat sessions (in Cowork/desktop
mode, not Codex). This file captures context, decisions, and conventions that live in
...
- **The project folder was moved from `~/Codex/Projects/Clean Gmail` to
